      ...
      <main className="flex-1 px-4 sm:px-6 py-8 max-w-5xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          ...
          <div className="rounded-xl bg-white/90 border border-blue-100 shadow-[0_8px_24px_-16px_rgba(15,23,42,0.25)] p-4">
            ...
            <p className="text-2xl font-bold text-slate-900 mt-1">{reviewedCount}</p>
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex items-center gap-2 shrink-0 ml-4">
                        {item.status === "pending" && (
                          <span className="px-3 py-1.5 rounded-lg bg-cyan-600 text-white text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1">
                            开始评审 <ArrowRight className="w-3 h-3" />
                          </span>
                        )}
                        {item.status !== "pending" && (
                          <span className="px-3 py-1.5 rounded-lg bg-slate-900 text-slate-100 text-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1">
